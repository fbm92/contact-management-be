...
class AddressService {
    static create(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactExist(user.username, request.contact_id);
    ...
    static checkAddressExist(idContact, addressId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static get(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactExist(user.username, request.contact_id);
            const address = yield this.checkAddressExist(getAddressRequest.contact_id, getAddressRequest.id);
            return (0, address_model_1.toAddressResponse)(address);
        });
    }
    static update(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactExist(user.username, request.contact_id);
            yield this.checkAddressExist(updateRequest.contact_id, updateRequest.id);
    ...
    static remove(user, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield contact_service_1.ContactService.checkContactExist(user.username, request.contact_id);
            yield this.checkAddressExist(removeRequest.contact_id, removeRequest.id);
    ...
    static list(user, idContact) {
        return __awaiter(this, void 0, void 0, function* () {
            yield contact_service_1.ContactService.checkContactExist(user.username, idContact);
            const result = yield database_1.prismaClient.address.findMany({
                where: {
                    contact_id: idContact
                }
            });
            return result.map(address => (0, address_model_1.toAddressResponse)(address));
        });
    }
}
