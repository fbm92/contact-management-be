...
class AddressController {
    static create(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                request.contact_id = Number(req.params.idContact);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const request = {
                    ...
                    contact_id: Number(req.params.idContact),
                };
    ...
    static list(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const contactId = Number(req.params.idContact);
                const address = yield address_service_1.AddressService.list(req.user, contactId);
                res.status(200).json({
                    data: address
                });
            }
